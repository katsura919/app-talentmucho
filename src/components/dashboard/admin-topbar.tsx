...
export function AdminTopbar({ fullName, email, onMenuClick }: Props) {
          ...
          {crumbs.map((crumb, i) => (
            <React.Fragment key={crumb.href}>
              ...
              <BreadcrumbItem>
                {crumb.isLast ? (
                  <BreadcrumbPage
                    className="font-serif font-light text-[var(--charcoal-900)] dark:text-foreground truncate"
                  ...
                  <BreadcrumbLink
                    href={crumb.href}
                    className="font-sans text-sm text-[var(--taupe-400)] hover:text-[var(--charcoal-900)] dark:hover:text-foreground"
                  >
                    {crumb.label}
                  </BreadcrumbLink>
                )}
              ...
              <DropdownMenuLabel className="flex flex-col gap-0.5 py-2">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{ background: "var(--clay-500)", color: "white" }}
                  >
                    Admin
                  </span>
                </div>
